...
class StoreVoucherModel extends \common\models\StoreVoucherModel
{
    ...
    public function getValue($request = [], $type = "add")
    {
        ...
        if (!empty($request["store_voucher_available_room_li"])) {
            $value["store_voucher_available_room_li"] = emptyRemoveArrString(
                $request["store_voucher_available_room_li"]
            );
        }
        if (!empty($request["store_voucher_available_days"])) {
            $value["store_voucher_available_days"] = emptyRemoveArrString(
